export const articleSections = [
    ...
    sectionBlocks: [
      {
        ...
        content: (
          <>
            Software Engineers remain among the most sought-after professionals.
            At the same time, programming is one of the most accessible skills
            to learn—all you need is a computer and an internet connection. As a
            developer, you will draw a decent salary (especially if you work on
            your subsidiary abilities, such as interview, presentation, and
            negotiation skills). The career also opens possibilities for
      ...
      },
      {
        ...
        content: (
          <>
            ...
            down this path, from square one, to foot-in-the-door, to comfortably
            positioned for a career in tech.
          </>
        ),
      },
    ],
  },
  {
    sectionBlocks: [
      {
        type: "header",
        content: <>Wait, but what about AI?</>,
      },
      {
        type: "paragraph",
        content: (
      ...
      },
      {
        ...
        content: (
          <>
            ...
            only boost you in your journey towards becoming a developer, if you
  ...
  },
  {
    sectionBlocks: [
      ...
      },
      {
        ...
        content: [
          <>
            <em>some</em> technical skills—you don’t have to be a wizard when
            you find your first job. Being a rookie is fine, as long as you have
            something to offer.
          </>,
      ...
      },
      {
        ...
        content: (
          <>
            However, when companies don’t know you, qualifications and a CV are
            important for getting your foot in the door. If you can get a job
            without them, great, but planning to get those boxes ticked is the
            most direct way to appeal to companies as a potential employee.
          </>
        ),
      },
    ],
  },
  {
    sectionBlocks: [
      ...
      },
      {
        ...
        content: [
          <>
            Codecademy is a website that teaches you how to write code, from the
            very basics. They have a free tier, and then you can pay a fairly
            reasonable fee for access to more learning modules.
          </>,
          <>
      ...
      },
      {
        ...
        content: [
          ...
          <>
            ...
            developers use to write their code), so that you can program along
            with these tutorials, and build your very first apps.
          </>,
          <>
      ...
      },
      {
        ...
        content: (
          <>
            ...
            skills, yes, but I actually think that learning by yourself is very
            important, which is why I listed it separately, in a prior step. You
            cannot wait for other people to give you permission to learn,
            especially in a world with such abundant self-paced online
      ...
      },
      {
        ...
        content: [
          ...
          <>
            ...
            takes an interest in helping you.
          </>,
          <>
            You might get opportunities to work with others in a structured way,
            which is very useful. Contrary to the stereotype of the lone,
            late-night programmer, software development is a highly
            collaborative profession.
          </>,
          <>
            You will build stuff, which will further increase your confidence,
            as well as broaden your portfolio (to later show in job
            applications).
          </>,
          <>
          ...
          <>
            You will get <em>something</em> to put on your CV and LinkedIn.
          </>,
        ],
      },
      {
        type: "paragraph",
        content: <>Which accreditation to pursue?</>,
      },
      {
        type: "unordered-list",
        content: [
          <>
            ...
            certain to lead to employment—even, ironically, when in some cases
            universities actually teach you less than other accreditation
            options.
          </>,
          <>
            Boot camps are very intense, but they don’t last long, and can also
            be very valuable for finding a job. Some boot camps have
            partnerships with companies, allowing graduates to get full-time
            jobs only months after first starting to program. I’ve personally
            known people who got their careers up-and-running very fast through
  ...
  },
  {
    sectionBlocks: [
      {
        type: "header",
        content: <>5. Make a CV and a LinkedIn page.</>,
      },
      {
        type: "paragraph",
        content: (
      ...
      },
      {
        ...
        content: (
          <>
            ...
            LinkedIn. A LinkedIn profile is an avatar of your professional self,
            so take a bit of time to deck it out. Get a professional photo
      ...
      },
      {
        ...
        content: (
          <>
            ...
            payment is the advancements in terms of learning and experience you
            make, the positive reference from your manager, and the entry on
            your CV.
          </>
        ),
      },
  ...
  },
  {
    sectionBlocks: [
      {
        type: "header",
        content: <>6. Get applying. And don&apos;t stop.</>,
      },
      {
        type: "paragraph",
        content: (
          <>
            There’s no real time that is too early to start applying to work at
            companies. Even if you have no experience, the worst thing that can
            happen when you apply to a company is that they say no. Work for
            free, if you have to. The thing you need is experience and new
      ...
      },
      {
        ...
        content: (
          <>
            ...
            Stay open to other channels as well though, because there are a lot
            of them (and the usefulness of a given platform may depend on your
            location).
          </>
        ),
      },
      {
        ...
        content: (
          <>
            ...
            applications are rejected. So don’t fear rejection. It may hurt, but
            you will get used to it, because you will receive so many that
            eventually you will just get bored of it. Similarly, unless you have
            a rare talent for interviewing, get used to the experience of having
            a bad interview. It’s similar to a comedian bombing onstage—happens
            to all, including the very best. It’s not a big deal, just try to
            use it as a chance to learn how to do a tiny bit better in the next
            one.
          </>
        ),
      },
      {
        ...
        content: (
          <>
            Keep going. Keep applying. Keep refining your approach, the way you
            present yourself, your CV and your LinkedIn. If you feel like things
            are just not coming together, aim lower. Approach a company, explain
            your situation, and offer to work for a while part-time for free.
            Remember, you are building skills and building a profile. One small
            win, one small project, one small internship—they all put you in a
            better position, slightly more likely to be able to progress. It’s
            hard work. But remember, this is the hard part. Be the person who
            can do hard things. If it was easy, everyone would do it.
          </>
        ),
      },
      {
