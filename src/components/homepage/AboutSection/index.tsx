...
const AboutSection = () => {
  return (
    <section
      id="about"
      className="min-h-screen py-16 bg-gradient-to-b from-sky-700 to-sky-950 flex flex-col justify-center px-4 md:px-0"
    >
      <div className="mx-auto">
        <h1
          // className="text-5xl bg-clip-text text-transparent mb-8"
          className="text-5xl bg-clip-text text-sky-100 mb-8"
          style={{
            // backgroundImage: "linear-gradient(90deg,#ffffff,#fef3c7)",
            textShadow: "2px 2px 4px rgba(0, 0, 0, 0.6)",
          }}
        >
          Beyond Development: Alex Blyth
        </h1>
      </div>
  ...
  return (
    <>
      {largeTitle ? (
        ...
        >
          <span className="px-2 bg-teal-700">{title}</span>
        </h2>
      ) : (
        <h3
